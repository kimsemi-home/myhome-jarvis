...
func summarizeAuthorityReview(status authority.ReviewPlanStatus) AuthorityReviewSummary {
	...
	return AuthorityReviewSummary{
		...
		ReviewRequestRecorded:           status.ReviewRequestRecorded,
		ReviewRequestRecordCount:        status.ReviewRequestRecordCount,
		ReviewRequestInvalidRecordCnt:   status.ReviewRequestInvalidRecordCount,
		ReviewRequestLedgerState:        status.ReviewRequestLedgerState,
		ReviewRequestApprovalState:      status.ReviewRequestApprovalState,
		ReviewRequestLastRecordedAt:     status.ReviewRequestLastRecordedAt,
		ReviewRequestAgeHours:           status.ReviewRequestAgeHours,
		ReviewRequestStaleAfterHours:    status.ReviewRequestStaleAfterHours,
		ReviewRequestStale:              status.ReviewRequestStale,
		ReviewRequestEscalationAction:   status.ReviewRequestEscalationAction,
