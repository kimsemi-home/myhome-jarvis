...
func testPolicy() Policy {
	return Policy{
		...
		Commands:            []string{"mhj authority status", "mhj authority-review status", "mhj authority-review brief", "mhj authority-review request", "mhj authority-review evidence", "mhj authority-review queue", "mhj authority-review record <json-payload>", "mhj authority-review approval-status", "mhj authority-review approve <json-payload>"},
	}
}
