...
type Status struct {
	...
	PublicRepoChangeGatedProfileCount int            `json:"public_repo_change_gated_profile_count"`
	WorkflowChangeGatedProfileCount   int            `json:"workflow_change_gated_profile_count"`
	SelfApprovalBlockedProfileCount   int            `json:"self_approval_blocked_profile_count"`
	ProfileKeys                       []string       `json:"profile_keys"`
	ReviewRequiredProfiles            []string       `json:"review_required_profiles"`
	PublicSafetyGatedProfiles         []string       `json:"public_safety_gated_profiles"`
