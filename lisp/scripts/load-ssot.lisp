...
(defun mhj-load-ssot ()
  (dolist (file '("../ssot/package.lisp"
                  ...
                  "../ssot/codegen-validate-shape-learning.lisp"
                  "../ssot/codegen-validate-evidence.lisp"
                  "../ssot/codegen-validate-confidence.lisp"
                  "../ssot/codegen-validate-ddd-core.lisp"
                  "../ssot/codegen-validate-ddd-links.lisp"
                  "../ssot/codegen-validate-control.lisp"
                  "../ssot/codegen-validate-incidents.lisp"
                  "../ssot/codegen-validate-evidence-quality.lisp"
                  "../ssot/codegen-validate-review.lisp"
                  "../ssot/codegen-validate-review-details.lisp"
                  "../ssot/codegen-validate-authority.lisp"
                  "../ssot/codegen-validate-authority-details.lisp"
                  "../ssot/codegen-validate-pdca.lisp"
