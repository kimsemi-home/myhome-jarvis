...
(defparameter *codex-sustainability-record-kinds*
  #("usage_sample" "cycle_sample" "trend_baseline" "feature_proposal"))

(defparameter *codex-sustainability-metrics*
...
(defparameter *codex-sustainability-policy*
  (list :context "CodexSustainabilityEvidenceLoop"
        :version "v1"
        :generated_artifact "generated/codex_sustainability.generated.json"
        :private_evidence_ledger "data/private/codex-sustainability/evidence.jsonl"
        :append_only t
        :public_status_redacted t
        :raw_evidence_public_allowed nil
        :trend_baselines_versioned t
        :evidence_max_age_hours 168
        :trend_baseline_max_age_hours 168
        :cost_per_accepted_change_review_threshold 500000
        :record_kinds *codex-sustainability-record-kinds*
        :metrics *codex-sustainability-metrics*
        :required_fields #("at" "record_kind" "evidence_refs")
        :proposal_required_fields #("proposal_id" "evidence_refs"
        ...
        :public_summary_fields #("policy_path" "ledger_path" "exists"
                                 ...
                                 "feature_proposal_count"
                                 "optimization_claim_without_evidence_count"
                                 ...
                                 "trend_posture"
                                 "sustainability_posture"
                                 "evidence_freshness"
                                 "review_gate_count"
                                 "latest_trend_baseline_version"
