...
(defun validate-codex-cost-policy (policy)
  ...
  (require-positive-integer (getf policy :attribution_cost_ref_max_length)
                            "Codex attribution cost ref length is required")
  (require-positive-integer (getf policy :roi_merge_log_limit)
                            "Codex ROI merge log limit is required")
  ...
  (require-command policy "mhj codex-cost scaling-packet"))
...
(defun validate-codex-cost-lists (policy)
  ...
  (require-members '("unit_kind" "amount" "evidence_refs")
                   (policy-list policy :attribution_cost_ref_inputs)
                   "Codex cost attribution cost ref input missing: ~A")
  (require-members '("codex_sustainability_ledger" "git_merge_commits")
                   (policy-list policy :roi_accepted_change_inputs)
                   "Codex cost ROI accepted-change input missing: ~A")
