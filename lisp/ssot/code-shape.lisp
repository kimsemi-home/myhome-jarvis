...
(defparameter *code-shape-policy*
  (list :context "AgentCluster"
        ...
        :legacy_debt_files #((:path "internal/daemon/server_test.go" :max_lines 1488) (:path "apps/flutter/lib/main.dart" :max_lines 1209)
                              (:path "crates/mhj-storage/src/lib.rs" :max_lines 1143) (:path "cmd/mhj/main.go" :max_lines 1093)
                              (:path "lisp/ssot/codegen.lisp" :max_lines 1062) (:path "apps/flutter/lib/daemon_client.dart" :max_lines 1018)
                              ...
                              (:path "internal/supervisor/status_test.go" :max_lines 104) (:path "internal/domain/summary_test.go" :max_lines 103)
                              (:path "internal/daemon/events.go" :max_lines 102) (:path "internal/auth/local.go" :max_lines 102)
                              (:path "internal/agentcluster/status_test.go" :max_lines 99) (:path "lisp/ssot/translation.lisp" :max_lines 98)
                              (:path "lisp/ssot/evidence.lisp" :max_lines 97) (:path "lisp/ssot/connectors.lisp" :max_lines 96)
                              ...
                              (:path "internal/connectors/status_test.go" :max_lines 85) (:path "internal/linear/status_test.go" :max_lines 84)
