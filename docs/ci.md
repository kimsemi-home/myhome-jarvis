...
Assessor, and Translation Manifest artifacts, plus the Control Plane Manifest
and Incident Lifecycle artifacts, because its daemon and fallback tests read
those Lisp-owned catalogs directly.
